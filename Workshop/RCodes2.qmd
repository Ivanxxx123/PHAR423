...
3.  Make a scatterplot of `bill_depth_mm` vs. `bill_length_mm`.
    ...
    The relationship between these 2 variables is not strong.
...
4.  What happens if you make a scatterplot of `species` vs. `bill_depth_mm`?
    ...
    The scatter plot is not displaying any relationship.

    Box plot will be a better choice
...
5.  Why does the following give an error and how would you fix it?
    ...
    The mapping is not assigned with variables.
...
7.  Add the following caption to the plot you made in the previous exercise: "Data come from the palmerpenguins package." Hint: Take a look at the documentation for `labs()`.
    ...
    ggplot(penguins, aes(x = bill_length_mm, y = bill_depth_mm))+
      geom_point()+
      geom_smooth(method ="lm")+
      labs(x = "bill length in mm", y = "bill depth in mm", caption = "Data come from the palmerpenguins package")
    ```
